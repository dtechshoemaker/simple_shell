 ...
 */
void  exit_bullet(char **cmd, char *input, char **argv, int c)
{
	int statue, i = 0;
...
/**
 * env - Display Enviroment Variable in the command line
 * @cmd:Parsed Command
 * @er:Statue of Last command Excuted
 * Return:Always 0
 */
int env(__attribute__((unused)) char **cmd, __attribute__((unused)) int er)
{
size_t i;
	int len;
